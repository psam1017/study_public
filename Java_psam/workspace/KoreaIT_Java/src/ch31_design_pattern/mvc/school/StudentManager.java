...
public class StudentManager {
	...
	public static Student findStudentInformation(int studentNumber) {
	...
	public static Student checkStudentNumber() {
	...
	public static void setClass(String msg, Student student, boolean check) {
	...
	public static void setScore() {
		...
		while(true) {
			...
			if(score < 0 || score > 100) {
				System.out.println("Error : 성적 범위가 올바르지 않습니다.");
				continue;
			}
