    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/board/html5-upload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/board/call-file-uploader',	//샘플 URL입니다.
 	      sCallback : '/smarteditor2-07e2304/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
