	...
	<div id="main">
		<div class="wrapper">
			<div class="inner">
				...
				<div class="content">
					<div class="form">
						<form method="post" action="#" id="registForm" name="registForm" enctype="multipart/form-data">
							<div class="fields">
								<div class="field">
									<h4>제목</h4>
	...
	$(document).ready(function(e){
		...
		$("input[type='submit']").on("click", function(e){
			...
			$(".uploadResult ul li").each(function(i, li){
				...
				str += "<input type='hidden' name='files[" + i + "].fileType' value='" + ($(li).data("filetype") || false) + "'>";
			});
